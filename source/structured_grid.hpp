...
namespace jflow {
    ...
    inline const double2& structured_grid_cell::vertex(std::size_t i) const {
        ...
        switch (i) {
            case 0: return parent.vertices[lower_left];
            case 1: return parent.vertices[lower_left + parent.nj];
            case 2: return parent.vertices[lower_left + parent.nj + 1];
            case 3: return parent.vertices[lower_left + 1];
        }
